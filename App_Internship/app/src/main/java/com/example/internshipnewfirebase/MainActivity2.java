...
public class MainActivity2 extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a1=findViewById(R.id.etName);
        a2=findViewById(R.id.etNumber);
        a3=findViewById(R.id.etTopic);
        a4=findViewById(R.id.etPlatform);
    ...
    void write1(){
        int rollno=Integer.parseInt(a2.getText().toString().trim());
        String fname=a1.getText().toString().trim();
        ...
        fr.child("students").child(""+rollno).setValue(st).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
